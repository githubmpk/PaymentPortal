...
export class RequestComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.page_expiry = localStorage.getItem('PageExpiry');
  ...
  openLink() {
    window.open('http://localhost:4200/payweb3/initiate?amt='+this.amount+'&em='+this.email+'&ex='+this.page_expiry, '_self');
  }
